...
const COPY = {
  en: {
    ...
    scopeBody: "AI-integrated digital systems, platforms, and business applications for organizations that need stronger positioning, disciplined execution, and zero drift from brief to launch. From landing pages to multi-surface ecosystems.",
    methodLabel: "Method",
  ...
  es: {
    ...
    scopeBody: "Sistemas digitales con IA integrada, plataformas y aplicaciones de negocio para organizaciones que necesitan mejor posicionamiento, ejecución disciplinada y cero desviación del brief al lanzamiento. Desde landing pages hasta ecosistemas multi-superficie.",
    methodLabel: "Método",
