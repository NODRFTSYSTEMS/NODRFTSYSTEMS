...
const COPY = {
  en: {
    ...
    scopeBody: "Modern websites, digital platforms, and business systems for organizations that need stronger positioning, better conversion, and more disciplined execution. From single landing pages to multi-surface ecosystems.",
    methodLabel: "Method",
  ...
  es: {
    ...
    scopeBody: "Sitios web modernos, plataformas digitales y sistemas de negocio para organizaciones que necesitan mejor posicionamiento, mayor conversión y ejecución más disciplinada. Desde landing pages hasta ecosistemas multi-superficie.",
    methodLabel: "Método",
