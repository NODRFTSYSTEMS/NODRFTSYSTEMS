...
const COPY = {
  en: {
    ...
    standardP1: "NoDrftSystems was built around a specific failure mode: digital builds that appear complete but aren’t—sites that misrepresent the firm, drift from spec during revision, or collapse when the team that built them is no longer accessible. This failure mode is common, expensive, and largely invisible until the damage is done.",
    ...
    standardP3: "The firm is named for the thing it refuses to allow. Not as a slogan—as a delivery constraint.",
    scopeLabel: "Scope",
    scopeHeading: "What we build",
    scopeBody: "AI-integrated digital systems, platforms, and operating applications — from conversion-focused websites to full-stack pharmacy management systems and real estate platforms. Built for organizations that need delivery discipline, multilingual infrastructure, and systems that stay correct long after the build team is off the engagement.",
    methodLabel: "Method",
    methodHeading: "How we work",
    methodBody: "Human authority drives every decision. AI tools accelerate production. Every deliverable passes multi-pass quality review. Scope is confirmed before work begins. Nothing ships without sign-off.",
  ...
  es: {
    ...
    standardP1: "NoDrftSystems fue construida en torno a un modo de fallo específico: construcciones digitales que parecen completas pero no lo son, sitios que tergiversan a la empresa, se desvían de las especificaciones durante las revisiones, o colapsan cuando el equipo que los construyó ya no está disponible. Este modo de fallo es común, costoso y en gran medida invisible hasta que el daño ya está hecho.",
    ...
    standardP3: "La empresa lleva el nombre de lo que se niega a permitir. No como eslogan, sino como restricción de entrega.",
    scopeLabel: "Alcance",
    scopeHeading: "Qué construimos",
    scopeBody: "Sistemas digitales, plataformas y aplicaciones operativas con IA integrada — desde sitios web orientados a la conversión hasta sistemas completos de gestión de farmacias y plataformas inmobiliarias. Construidos para organizaciones que necesitan disciplina de entrega, infraestructura multilingüe y sistemas que se mantengan correctos mucho después de que el equipo de construcción haya concluido el proyecto.",
    methodLabel: "Método",
    methodHeading: "Cómo trabajamos",
    methodBody: "La autoridad humana guía cada decisión. Las herramientas de IA aceleran la producción. Revisión multi-paso en cada entrega. El alcance se confirma antes de iniciar. Nada se publica sin aprobación.",
