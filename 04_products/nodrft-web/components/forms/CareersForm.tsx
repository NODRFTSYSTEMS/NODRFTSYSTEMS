...
const COPY = {
  en: {
    ...
    briefPh: "What you do, what you're best at, and why you're interested in working with a firm that operates under a governance-first delivery standard. Be specific — generic applications aren't evaluated.",
  ...
  es: {
    ...
    briefPh: "Qué hace, en qué es mejor y por qué le interesa trabajar con una firma que opera bajo un estándar de entrega con gobernanza primero. Sea específico — las aplicaciones genéricas no se evalúan.",
